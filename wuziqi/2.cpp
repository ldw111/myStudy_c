            ...
            if(is_set_bit(buf_2[i][j],0))
            {
                ...
                for(int k = 1;k < 5;k++)
                {
                    ...
                    else if(is_set_bit(buf_2[i][j+k],0))
                    {
                        set_bit(buf_2[i][j+k],2);
                        flag++;
                    }
                    else
                    {
                ...
                if(!list_point3->isEmpty())
                {
                    ...
                    for(int k = 1;k <= a;k++)
                    {
                        if(k == a)
                        {
                            if(j - k < 0 || is_set_bit(buf_2[i][j-k],1))
                            {
                                QPoint *point = new QPoint(j-k,i);
                                list_point3->append(point);
                            }
                ...
                if(!list_point2->isEmpty())
                {
                    ...
                    else if(x == -1 && is_set_bit(buf_2[y][x+1],0))
                    {
                        flag1 = 1;
                    }
                    else if(x != -1 && is_set_bit(buf_2[y][x-1],0))
            ...
            if(is_set_bit(buf_2[i][j],0))
            {
                ...
                for(int k = 1;k < 5;k++)
                {
                    ...
                    else if(is_set_bit(buf_2[i+k][j],0))
                    {
                        set_bit(buf_2[i+k][j],3);
                        flag++;
                    }
                    else
                    {
                ...
                if(!list_point3->isEmpty())
                {
                    ...
                    for(int k = 1;k <= a;k++)
                    {
                        if(k == a)
                        {
                            if(i - k < 0 || is_set_bit(buf_2[i-k][j],1))
                            {
                                QPoint *point = new QPoint(j,i-k);
                                list_point3->append(point);
                            }
                ...
                if(!list_point2->isEmpty())
                {
                    ...
                    else if(y == -1 && is_set_bit(buf_2[y+1][x],0))
                    {
                        flag1 = 1;
                    }
                    else if(y != -1 && is_set_bit(buf_2[y-1][x],0))
            ...
            if(is_set_bit(buf_2[i][j],0))
            {
                ...
                if(!list_point3->isEmpty())
                {
                    ...
                    for(int k = 1;k <= a;k++)
                    {
                        if(k == a)
                        {
                            if(i - k < 0 || j - k < 0 || is_set_bit(buf_2[i-k][j-k],1))
                            {
                                QPoint *point = new QPoint(j-k,i-k);
                                list_point3->append(point);
                            }
                ...
                if(i - 1 < 0 || j - 1 < 0)
                {
                    QPoint *point = new QPoint(i-1,j-1);
                    list_point3->append(point);
                }
                if(!list_point2->isEmpty())
                {
                    ...
                    else if((y == -1 || x == -1) && is_set_bit(buf_2[y+1][x+1],0))
                    {
                        flag1 = 1;
                    }
                    else if((y != -1 && x != -1) && is_set_bit(buf_2[y-1][x-1],0))
